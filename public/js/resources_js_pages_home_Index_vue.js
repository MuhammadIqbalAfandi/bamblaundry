...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    var expose = _ref.expose;
    expose();
    var colors = ['#349dcf', '#00b2da', '#00c7dd', '#1fdbdb', '#57eed3', '#88ffc9', '#96ed9a', '#a8d96c', '#bbc242', '#cda91d'];

    var transactionBarData = function transactionBarData(chartData) {
      var colors = ['#349dcf', '#a8d96c'];
      var data = {
        datasets: []
      };
      var id = 0;
    ...
    var topTransactionData = function topTransactionData(chartData) {
      var labels = [];
      var data = [];

      var _iterator = _createForOfIteratorHelper(lodash_orderBy__WEBPACK_IMPORTED_MODULE_1___default()(chartData, ['totalPrice'], ['desc'])),
          _step;

      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var _chartData = _step.value;
          labels.push([_chartData.customerNumber, _chartData.name]);
          data.push(_chartData.totalPrice);
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
    ...
    var __returned__ = {
      ...
      topTransactionData: topTransactionData,
      topTransactionOption: topTransactionOption,
      Head: _inertiajs_inertia_vue3__WEBPACK_IMPORTED_MODULE_0__.Head,
      orderBy: (lodash_orderBy__WEBPACK_IMPORTED_MODULE_1___default()),
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["AppLayout"], null, {
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      ...
      /* UNKEYED_FRAGMENT */
      )), _ctx.$page.props.auth.user.role_id === 1 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_13, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Card, null, {
        title: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      ...
      })])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_16, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Card, null, {
        title: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
        ...
        content: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Chart, {
            ...
            width: 600,
            height: 300,
            data: $setup.topTransactionData($props.chartTopTransactionStatistic.data),
            options: $setup.topTransactionOption
          }, null, 8
          /* PROPS */
          , ["data"])];
        }),
